...
do_install() {
 ...
 if [ -f "${STAGING_KERNEL_DIR}/arch/${ARCH}/boot/dts/skeleton.dtsi" ]; then
...
do_install:append:tppg2() {
 ...
 install -m 0644 ${STAGING_KERNEL_DIR}/arch/${ARCH}/boot/dts/sp7021*.dts ${D}/opt/tps-shared/dts-orig/
